  ...
  <div v-else>
    <div class="pt-16">
      ...
      >
        ...
        >
          <p
            class="border-b pb-5 font-medium text-center text-2xl max-md:text-lg text-red-500"
          >
            Tugallangan
          </p>
          <p
          ...
          <div
            class="col-span-4 w-full max-md:w-[650px] grid grid-cols-4 justify-center mt-5 items-center rounded-md bg-white"
          >
...
const updateStatus = async (id) => {
  try {
    await axios.patch(`http://95.130.227.176:3015/api/order-status/${id}`, {
      status: "accepted",
    });
